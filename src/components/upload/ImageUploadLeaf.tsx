...
const ImageUploadLeaf = () => {
  ...
  const handleClassify = async () => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:5000/leaf-disease", {
        method: "POST",
        body: formData,
      });
      if (!response.ok) {
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto p-6 w-full bg-white bg-opacity-90 rounded-lg z-10">
          ...
          {preview ? (
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <label className="inline-block bg-purple-600 text-white px-6 py-2 rounded-md hover:bg-purple-700 transition-colors cursor-pointer">
                  Select Image
                  <input
                    type="file"
                    className="hidden"
