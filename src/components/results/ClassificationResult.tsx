...
const ClassificationResult = () => {
  ...
  const recipes =
    mulberryType === "Sri Lankan Mulberry"
      ...
      : mulberryType === "Foreign Mulberry"?["Mulberry Tart", "Mulberry Syrup", "Mulberry Salad"]:[];
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex flex-col md:flex-row items-center bg-white p-6 rounded-lg shadow-2xl max-w-4xl w-full"
      ...
      >
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center">
          ...
          <button
            ...
            className="mt-6 bg-purple-600 text-white px-6 py-3 rounded-md hover:bg-purple-700 transition duration-300"
          >
      ...
      {mulberryType != "Could not be Recognized" && (
        <motion.div
        className="mt-10 bg-white p-6 pl-20 rounded-lg shadow-2xl max-w-3xl w-full "
