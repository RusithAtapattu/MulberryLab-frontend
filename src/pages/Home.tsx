    ...
    <>
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 pb-10 bg-gray-100">
        ...
        <div className="text-center">
          <motion.h1>
            <h1 className="text-6xl font-bold text-gray-900 pt-20 pb-6">
              Explore Mulberry Varieties
              <span className="block text-5xl text-green-700 pt-2">
                Like Never Before
              </span>
            </h1>
          </motion.h1>
        ...
        <div className="pt-6 flex items-center w-full">
          <div
            ...
            className="relative group bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer w-[50%] mx-auto"
          >
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {mulberries.map((mulberry, index) => (
            ...
            >
              ...
              />
              <p className="text-gray-600 text-center mt-2 w-[85%]">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between w-full mx-auto px-6  bg-gray-100 pt-4 pb-16">
        {/* Left Side - Text Content */}
        <div className="w-full md:w-1/2 text-left px-10 pb-8">
          <h2 className="text-2xl md:text-3xl text-green-600 font-light mt-1">
            NATURE’S SUPERFOOD
          </h2>
        ...
        <div className="relative w-full md:w-1/2 flex justify-center mt-10 md:mt-0">
          ...
          <div className="absolute w-80 h-80 md:w-96 md:h-96 bg-green-900 rounded-full -z-10 top-8 right-0 md:right-10"></div>

          {/* Main Image */}
          <div className="relative w-120 h-120 md:w-80 md:h-80 bg-white rounded-full flex items-center justify-center shadow-xl shadow-gray-400 overflow-hidden">
            <img
              src="iStock.jpg"
      ...
      <div className="bg-[#E9941C] text-white py-20 px-6">
        {/* Title */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto relative ">
          ...
          <div className="flex flex-col items-center text-center relative md:-top-6 border bg-[#0C5B02] border-yellow-700 rounded-lg p-4 transform transition duration-300 hover:scale-105">
            ...
            <h3 className="text-2xl font-semibold mt-4 text-yellow-500">
              Powdery Mildew
            </h3>
            <p className="text-gray-300 mt-2 px-4">
